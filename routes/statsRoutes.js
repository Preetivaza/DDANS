...
router.get('/user-activity', authMiddleware(['admin',"authority"]), getUserActivityReport);
...
router.get('/custom-report', authMiddleware(['admin',"authority"]), getCustomDateRangeReport);
